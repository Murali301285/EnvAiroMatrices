                        ...
                        <div className="p-6 overflow-y-auto flex-1 space-y-5">
                            ...
                            <div className="p-4 bg-slate-50 border border-slate-100 rounded-xl space-y-4 relative z-0">
                                ...
                                <div className="grid grid-cols-2 gap-4 pt-2 border-t border-slate-200/60 mt-2">
                                    <div>
                                        <label className="block text-xs font-medium text-slate-600 mb-1">PCH Time Frame (mins)</label>
                                        <input type="number" min="0" value={formPchTimeframe} onChange={e => setFormPchTimeframe(e.target.value)} className="w-full px-3 py-2 border border-slate-200 rounded-lg focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 outline-none transition-all text-sm bg-white" placeholder="e.g. 60" />
                                    </div>
                                    <div>
