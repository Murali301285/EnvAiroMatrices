CREATE OR REPLACE FUNCTION public.sp_get_woloo_schjsoncreator(p_deviceid character varying, p_ref_time timestamp default null)
            ...
            BEGIN
                ...
                pch_cycles AS (
                    SELECT 
                        ...
                        COALESCE(MAX((m.metrics->>'OUT_RAW')::NUMERIC), 0) - COALESCE(MIN((m.metrics->>'OUT_RAW')::NUMERIC), 0) AS out_delta,
