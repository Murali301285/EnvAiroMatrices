...
DECLARE
    ...
    -- Apply 1-minute execution buffer (so script running at :15 evaluates logically as :14)
    v_current_time     TIMESTAMP := date_trunc('minute', COALESCE(p_ref_time, CURRENT_TIMESTAMP)) - INTERVAL '1 minute';
