    ...
    try:
        with conn.cursor() as cursor:
            ...
            for dev in devices:
                ...
                # Apply 5-minute execution buffer (so script running at :20 evaluates up to :15)
                logical_now = datetime.datetime.now().replace(second=0, microsecond=0) - datetime.timedelta(minutes=5)
